<template>
  <scroll ref="scroll" :data="result" class="hubtlist" :pullup="pullup" @scrollToEnd="searchmore" @beforeScroll='listscroll' :beforeScroll='beforeScroll'>
    <ul>
    ...
    <div class="nodata" v-show="!result.length">没有找到</div>
  </scroll>
</template>
...
<script type="text/ecmascript-6">  
  ...
  export default {
    ...
    watch:{
      query(newquery){        
        this.newqu=newquery   
        setTimeout(this.huntmethods(newquery),500)       
      }
    },
    components:{
      scroll,
